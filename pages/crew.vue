  ...
  <div class="bg-crew-bg-mobile md:bg-crew-bg-tablet lg:bg-crew-bg-desktop text-white md:h-full h-screen bg-cover bg-fixed bg-bottom">
    ...
    <main class="static container mx-auto">
      <div class="grid grid-cols-12 gap-6 lg:grid-flow-col lg:grid-row-5 lg:content-center">
        ...
        <div class="md:text-left grid col-span-6 col-start-4 md:order-3 md:col-span-10 md:col-start-3 lg:col-span-5 lg:row-span-5">
          <div class="">
            <img
              class="pt-8 lg:px-8"
        ...
        <TheNavCrew class="col-span-10 col-start-2 md:order-2 lg:col-span-6 lg:col-start-2 lg:text-left" />

        <div class="col-span-10 col-start-2 text-center pt-5 lg:self-end space-y-5 pb-5 md:space-y-0 lg:space-x-12 lg:col-span-6 lg:col-start-2 lg:text-left">
          <div class="space-y-2">
        ...
        <div class="col-span-10 col-start-2 text-center font-barlow text-regular-text pb-5 font-color-blueish md:text-regular-text-tablet lg:text-regular-text md:leading-regular-text-tablet lg:leading-regular-text lg:col-span-4 lg:col-start-2 lg:text-left">
          {{
              members.crew[`${$route.query.member}`]
                .bio
            }}
...
export default {
  ...
  beforeCreate() {
    if (!this.$route.query.member) {
      this.$router.push({ query: { member: "0" } })
      // this.$route.query.member = "0"
    }
  },
}
</script>
